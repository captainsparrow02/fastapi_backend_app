# This is a special file in pytest to store all fixtures which will be available throughout the tests package.
...
def test_user(client):
    user_data = {"email":"test@user.com", "password":"1234"}
...
def test_user2(client):
    user_data = {"email":"test2@user.com", "password":"1234"}
    res = client.post("/users/", json = user_data)
    assert res.status_code == 201
    new_user = res.json()
    new_user['password'] = user_data['password']
